function merge_visual_data_subjects(subjects)
...
%     subj_file=fullfile(subj_dir, 'mpdots_rcinstr_Tafdf.mat');
%     
...
% matlabbatch{batch_idx}.spm.meeg.other.copy.outfile = fullfile(base_data_dir, 'mpdots_rcinstr_Tafdf.mat');
% batch_idx=batch_idx+1;
% 
...
base_data_dir=fullfile('/home/bonaiuto/Dropbox/Projects/inProgress/dipole_moment_priors/data');
subject_files={};
...
for idx=1:length(subjects)
    ...
    subj_dir=fullfile(base_data_dir,subj_init);
    subj_file=fullfile(subj_dir, 'mpinstr_rcinstr_Tafdf.mat');
...
[path filename]=fileparts(subject_files{end,1});
matlabbatch{batch_idx}.spm.meeg.other.copy.D = {sprintf('c%s.mat', filename)};
matlabbatch{batch_idx}.spm.meeg.other.copy.outfile = fullfile(base_data_dir, 'mpinstr_rcinstr_Tafdf.mat');
batch_idx=batch_idx+1;
