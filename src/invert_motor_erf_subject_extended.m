function f_val=invert_motor_erf_subject_extended(subj_info, method, ori_surface, loc_surface, surf_name, woi, varargin)
...
coreg_fname=fullfile(data_dir, sprintf('ori_%s.loc_%s_mprcresp_Tafdf_%s.mat',ori_surface,loc_surface,method));
...
matlabbatch{batch_idx}.spm.meeg.source.headmodel.meshing.meshes.custom.cortex = {fullfile(subj_surf_dir,surf_name)};
